  ...
  <div className="card mb-4">
    <div className="card-body">
      ...
      <ul className="list-group">
        <li className="list-group-item">Integrity – We work in a trustworthy, compassionate and ethical manner.</li>
        <li className="list-group-item">Respect – We value the self-worth of our staff, volunteers and populations we serve.</li>
        <li className="list-group-item">Inclusion – We are strengthened by diversity.</li>
        <li className="list-group-item">Creativity – We are innovative and willing to try new approaches.</li>
        <li className="list-group-item">Commitment – We demonstrate quality performance and dedication.</li>
        <li className="list-group-item">Teamwork – Together we accomplish more.</li>
      </ul>
