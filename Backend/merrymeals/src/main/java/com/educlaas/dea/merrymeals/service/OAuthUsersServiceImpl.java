...
import com.educlaas.dea.merrymeals.exception.OAuthAuthenticationException;
import com.educlaas.dea.merrymeals.oauth2users.OAuth2Users;
import com.educlaas.dea.merrymeals.oauth2users.OAuth2UsersFactory;
...
public class OAuthUsersServiceImpl extends DefaultOAuth2UserService{
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) throws OAuthAuthenticationException {
        ...
        return UsersPrincipal.createUser(user);
    }
